...
"border: none;")
    ...
    def retranslateUi(self, Statistic):
        ...
        self.SensorData.setText(_translate("Statistic", "Sensor Data"))
        self.SensorData_data_temp.setText(_translate("Statistic", "t"))
        self.SensorData_data_humidity.setText(_translate("Statistic", "h"))
        self.SensorData_data_date.setText(_translate("Statistic", "dd:mm:yyyy"))
        ...
        self.WeatherBit_data_temp_cds.setText(_translate("Statistic", "t"))
        self.WeatherBit_data_humidity_cds.setText(_translate("Statistic", "h"))
        self.WeatherBit_data_date_cds.setText(_translate("Statistic", "dd:mm:yyyy"))
        self.WeatherBit_cds.setText(_translate("Statistic", "WeatherBit"))
        self.OWM_data_temp_cds.setText(_translate("Statistic", "t"))
        self.OWM_data_humidity_cds.setText(_translate("Statistic", "h"))
        self.OWM_data_date_cds.setText(_translate("Statistic", "dd:mm:yyyy"))
        ...
        self.OWM_data_temp_sdds.setText(_translate("Statistic", "t"))
        self.OWM_data_humidity_sdds.setText(_translate("Statistic", "h"))
        self.OWM_data_date_sdds.setText(_translate("Statistic", "dd:mm:yyyy"))
        self.WeatherBit_sdds.setText(_translate("Statistic", "WeatherBit"))
        self.WeatherBit_data_temp_sdds.setText(_translate("Statistic", "t"))
        self.WeatherBit_data_humidity_sdds.setText(_translate("Statistic", "h"))
        self.WeatherBit_data_date_sdds.setText(_translate("Statistic", "dd:mm:yyyy"))
